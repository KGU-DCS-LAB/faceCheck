package com.dcs.faceCheckserver.auth.jwt;
...
public class TokenProvider {
    ...
    public TokenProvider(@Value("${jwt.secret}") String secretKey) {
        ...
        // 이 부분에서 키의 크기를 확인하고, 부족하다면 적절하게 처리
        if (keyBytes.length < 512 / 8) {
            throw new SignatureException("서명 키의 크기가 HS512 알고리즘에 대해 안전하지 않습니다. 최소 512 비트 이상이어야 합니다.");
        }
